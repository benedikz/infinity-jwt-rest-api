	...
	class Rest {
		...
		public function validateToken() {
			try {
				...
				$stmt = $this->dbConn->prepare("SELECT * FROM infinity_users WHERE id = :userId");
				...
				if( $user['active'] == 0 ) {
					$this->returnResponse(USER_NOT_ACTIVE, "This user may be deactivated. Please contact the admin.");
				}
		...
		public function processApi() {
			try {
				...
				$this->throwError(API_DOES_NOT_EXIST, $e);
			}
